...
/**
 * A pill kept visually compact (19px, ~37px tall) with a 44px touch target
 ...
 * is recentred on the taller pill: (44 - 37) / 2 = 3.5, rounded to 4.
 */
const PILL =
  "relative inline-flex items-center rounded-full px-3 py-[9px] text-sm font-medium leading-none " +
  "transition-colors after:absolute after:inset-x-0 after:-top-[4px] after:h-11 after:content-['']";
