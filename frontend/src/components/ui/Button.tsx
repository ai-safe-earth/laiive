...
/**
 * 44px floor on every target. The icon size is 48 rather than the floor
 * because the composer's mic and send flank a field that is 48px on one line
 * — they are sized to it, and a 44px pill next to a 48px field reads as a
 * mistake. Text buttons keep the floor: 20px copy fits 44px comfortably.
 */
